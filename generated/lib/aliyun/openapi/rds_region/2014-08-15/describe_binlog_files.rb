...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').rds_region(version: '2014-08-15').describe_binlog_files.end_point do |end_point|
    ...
    end_point.param :'PageSize', :Integer, false, {"maxValue"=>"1000", "minValue"=>"30", "tagPosition"=>"Query"}
