...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').rds_region(version: '2014-08-15').describe_backups.end_point do |end_point|

    end_point.param :'OwnerId', :Long, false, {"tagPosition"=>"Query"}
    end_point.param :'ResourceOwnerAccount', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'ResourceOwnerId', :Long, false, {"tagPosition"=>"Query"}
    end_point.param :'DBInstanceId', :String, true, {"tagPosition"=>"Query"}
    end_point.param :'BackupId', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'BackupLocation', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'BackupStatus', :String, false, {"tagPosition"=>"Query"}
