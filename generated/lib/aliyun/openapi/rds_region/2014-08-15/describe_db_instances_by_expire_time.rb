...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').rds_region(version: '2014-08-15').describe_db_instances_by_expire_time.end_point do |end_point|
    ...
    end_point.param :'ExpirePeriod', :Integer, true, {"maxValue"=>"180", "minValue"=>"1", "tagPosition"=>"Query"}
