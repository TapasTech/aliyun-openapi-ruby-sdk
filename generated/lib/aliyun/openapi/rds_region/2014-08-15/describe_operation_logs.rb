...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').rds_region(version: '2014-08-15').describe_operation_logs.end_point do |end_point|
    ...
    end_point.param :'DBInstanceUseType', :String, false, {"tagPosition"=>"Query"}
