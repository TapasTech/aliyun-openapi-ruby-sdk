...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').rds_region(version: '2014-08-15').describe_sql_log_records.end_point do |end_point|
    ...
    end_point.param :'SQLId', :Long, false, {"tagPosition"=>"Query"}
    end_point.param :'QueryKeywords', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'StartTime', :String, true, {"tagPosition"=>"Query"}
    end_point.param :'EndTime', :String, true, {"tagPosition"=>"Query"}
    end_point.param :'PageSize', :Integer, false, {"maxValue"=>"200", "minValue"=>"30", "tagPosition"=>"Query"}
