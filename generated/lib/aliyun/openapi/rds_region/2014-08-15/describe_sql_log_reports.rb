...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').rds_region(version: '2014-08-15').describe_sql_log_reports.end_point do |end_point|
    ...
    end_point.param :'ReportType', :String, false, {"tagPosition"=>"Query"}
