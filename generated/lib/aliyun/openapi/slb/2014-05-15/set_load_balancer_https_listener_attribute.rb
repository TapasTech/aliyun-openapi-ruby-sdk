...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').slb(version: '2014-05-15').set_load_balancer_https_listener_attribute.end_point do |end_point|
    ...
    end_point.param :'ServerCertificateId', :String, false, {"tagPosition"=>"Query"}
