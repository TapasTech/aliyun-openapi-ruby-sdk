...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').slb(version: '2014-05-15').set_load_balancer_tcp_listener_attribute.end_point do |end_point|
    ...
    end_point.param :'HealthCheckType', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'SynProxy', :String, false, {"tagPosition"=>"Query"}
