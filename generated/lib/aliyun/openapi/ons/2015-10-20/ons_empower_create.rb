...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').ons(version: '2015-10-20').ons_empower_create.end_point do |end_point|
    ...
    end_point.param :'EmpowerUser', :String, true, {"tagPosition"=>"Query"}
    end_point.param :'Topic', :String, true, {"tagPosition"=>"Query"}
    end_point.param :'Relation', :Integer, true, {"tagPosition"=>"Query"}
    # end point methods
