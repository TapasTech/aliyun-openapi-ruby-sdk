...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').ons(version: '2015-10-20').ons_consumer_status.end_point do |end_point|
    ...
    end_point.param :'NeedJstack', :Boolean, false, {"tagPosition"=>"Query"}
    # end point methods
