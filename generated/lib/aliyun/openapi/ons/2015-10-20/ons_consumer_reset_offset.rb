...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').ons(version: '2015-10-20').ons_consumer_reset_offset.end_point do |end_point|
    ...
    end_point.param :'ResetTimestamp', :Long, true, {"tagPosition"=>"Query"}
    # end point methods
