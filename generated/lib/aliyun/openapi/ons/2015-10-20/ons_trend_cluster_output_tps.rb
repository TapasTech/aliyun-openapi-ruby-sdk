...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').ons(version: '2015-10-20').ons_trend_cluster_output_tps.end_point do |end_point|
    ...
    end_point.param :'Cluster', :String, true, {"tagPosition"=>"Query"}
