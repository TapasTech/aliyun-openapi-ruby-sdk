...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').rds(version: '2014-08-15').switch_db_instance_net_type.end_point do |end_point|
    ...
    end_point.param :'Port', :String, false, {"tagPosition"=>"Query"}
