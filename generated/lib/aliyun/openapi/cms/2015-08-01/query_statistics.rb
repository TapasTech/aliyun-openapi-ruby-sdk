...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').cms(version: '2015-08-01').query_statistics.end_point do |end_point|
    ...
    end_point.param :'TargetPeriod', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'Function', :String, false, {"tagPosition"=>"Query"}
