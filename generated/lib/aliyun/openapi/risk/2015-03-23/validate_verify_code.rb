...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').risk(version: '2015-03-23').validate_verify_code.end_point do |end_point|
    ...
    end_point.param :'VerifyCode', :String, true, {"tagPosition"=>"Query"}
