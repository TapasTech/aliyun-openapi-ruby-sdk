...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').otsfinance(version: '2013-09-12').insert_instance.end_point do |end_point|

    end_point.param :'InstanceName', :String, true, {"tagPosition"=>"Query"}
    end_point.param :'ClusterName', :String, false, {"tagPosition"=>"Query"}
