...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').ossadmin(version: '2015-05-20').create_img_vpc.end_point do |end_point|
    ...
    end_point.param :'VirtualSwitchId', :String, true, {"tagPosition"=>"Query"}
