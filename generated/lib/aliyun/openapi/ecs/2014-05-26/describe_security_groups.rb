...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').ecs(version: '2014-05-26').describe_security_groups.end_point do |end_point|
    ...
    end_point.param :'SecurityGroupIds', :String, false, {"tagPosition"=>"Query"}
    # end point methods
