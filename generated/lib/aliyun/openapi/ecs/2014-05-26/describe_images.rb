...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').ecs(version: '2014-05-26').describe_images.end_point do |end_point|
    ...
    end_point.param :'ShowExpired', :Boolean, false, {"tagPosition"=>"Query"}
    end_point.param :'SnapshotId', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'ImageName', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'ImageOwnerAlias', :String, false, {"tagPosition"=>"Query"}
