...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').sts(version: '2015-04-01').assume_role_with_service_identity.end_point do |end_point|
    ...
    end_point.param :'AssumeRoleFor', :String, true, {"tagPosition"=>"Query"}
    # end point methods
