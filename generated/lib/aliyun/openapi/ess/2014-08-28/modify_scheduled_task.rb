...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').ess(version: '2014-08-28').modify_scheduled_task.end_point do |end_point|

    end_point.param :'OwnerId', :Long, false, {"tagPosition"=>"Query"}
    end_point.param :'ResourceOwnerAccount', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'ResourceOwnerId', :Long, false, {"tagPosition"=>"Query"}
    end_point.param :'ScheduledTaskId', :String, true, {"tagPosition"=>"Query"}
    ...
    end_point.param :'ScheduledAction', :String, false, {"tagPosition"=>"Query"}
