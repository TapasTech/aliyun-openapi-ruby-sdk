...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').ess(version: '2014-08-28').describe_scaling_instances.end_point do |end_point|

    end_point.param :'OwnerId', :Long, false, {"tagPosition"=>"Query"}
    end_point.param :'ResourceOwnerAccount', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'ResourceOwnerId', :Long, false, {"tagPosition"=>"Query"}
    end_point.param :'ScalingGroupId', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'ScalingConfigurationId', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'HealthStatus', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'LifecycleState', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'CreationType', :String, false, {"tagPosition"=>"Query"}
    ...
    end_point.param :'InstanceId.1', :String, false, {"tagPosition"=>"Query"}
