...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').alert(version: '2015-08-15').list_contact.end_point do |end_point|

    end_point.param :'ProjectName', :String, true, {"tagPosition"=>"Path"}
    end_point.param :'ContactName', :String, false, {"tagPosition"=>"Query"}
    ...
    end_point.pattern = "/projects/[ProjectName]/contacts"
