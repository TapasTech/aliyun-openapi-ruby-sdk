...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').alert(version: '2015-08-15').disable_alert.end_point do |end_point|
    ...
    end_point.pattern = "/projects/[ProjectName]/alerts/[AlertName]/disable"
