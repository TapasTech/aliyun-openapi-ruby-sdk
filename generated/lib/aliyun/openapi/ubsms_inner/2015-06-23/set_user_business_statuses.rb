...
module Aliyun::Openapi
  Core::ApiDSL.define('openapi').ubsms_inner(version: '2015-06-23').set_user_business_statuses.end_point do |end_point|

    end_point.param :'Uid', :String, true, {"tagPosition"=>"Query"}
    end_point.param :'ServiceCode', :String, true, {"tagPosition"=>"Query"}
    end_point.param :'StatusKey1', :String, false, {"tagPosition"=>"Query"}
    end_point.param :'StatusValue1', :String, false, {"tagPosition"=>"Query"}
